...
const (
	FinalizerString = "finalizers.s3files.services.k8s.aws/FileSystem"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("filesystems")
